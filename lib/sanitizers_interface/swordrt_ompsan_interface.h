...
extern "C" {
void __ompsan_init();
void __ompsan_flush_shadow();

void __ompsan_read1(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_read2(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_read4(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_read8(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_read16(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);

void __ompsan_write1(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_write2(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_write4(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_write8(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
void __ompsan_write16(void *addr, uint64_t pc1, u64 *cell1, u64 *cell2);
