...
class HashFunction1 = murmurhash3<T, 101>,
class HashFunction2 = murmurhash3<T, 131>,
...
public:
			...
			size_t count() const
	{
		...
		return ret;
			...
			void insert(size_t hash_value1, size_t hash_value2, const T& t, uint64_t val)
			{
				apply_hash_type::insert(t, val,
						this->bits,
						this->num_bins(), hash_value1, hash_value2);
			}
			...
			bool contains(const T& t, uint64_t val, size_t *hash_value1, size_t *hash_value2) const
			{
				return apply_hash_type::contains(t, val,
						this->bits,
						this->num_bins(), hash_value1, hash_value2);
			...
			bool contains(size_t hash_value1, size_t hash_value2, const T& t, uint64_t val) const
			{
				return apply_hash_type::contains(t, val,
						this->bits,
						hash_value1, hash_value2, this->num_bins());
			}
